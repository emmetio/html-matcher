...
export default function(value, start, end) {
	if (value && typeof value === 'object') {
		...
		value = value.substring(start, end || value.location);
...
export class Token {
	 ...
	 * @param {Object} start Tokens’ start location in content stream
	 * @param {Object} end   Tokens’ end location in content stream
	 */
